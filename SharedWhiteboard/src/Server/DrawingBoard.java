...
public class DrawingBoard extends JPanel {
	...
	private DataOutputStream output;	//Here I guess only the output is enough
	...
	public DrawingBoard(ArrayList<connectionServer> cl) {
		connectionList = cl;
...
//        graphics2D.setStroke(new BasicStroke(4));
      ...
      public void sendToClient() {
    	  ...
    	  for(int i=0; i< connectionList.size(); i++) {
    		  //System.out.println("sendToClient" + i +"in DrawingBoard");
    		  connectionList.get(i).sendPainting(); 
		  }
      }
      public void loadFromClient(int length, ObjectInputStream objInput) throws ClassNotFoundException, IOException {
          shapes.clear();
          shapeFill.clear();
          shapeStroke.clear();
          for(int i=0; i<length; i++)
          {
              ...
              shapeFill.add((Color) objInput.readObject());
              shapeStroke.add((Color) objInput.readObject());
          }
          repaint();
      }
